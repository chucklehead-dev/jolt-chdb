...
`resources/jdbc/chdb/ffi-compatibility.edn`: Jolt `v0.8.10` (a release build or
a commit derived from that release), with hosted CI pinned to the exact release
commit recorded alongside it; Babashka
`v1.13.220` at commit
